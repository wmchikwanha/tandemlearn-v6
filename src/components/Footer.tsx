    ...
    <footer className="fixed bottom-0 left-0 right-0 py-3 px-6 z-10 pointer-events-none">
      <div className="flex justify-between items-end">
        ...
        <div className="pointer-events-auto text-[10px] text-muted-foreground opacity-60 space-x-2">
          ...
          <span>•</span>
          <Link to="/guardian" className="hover:text-primary hover:opacity-100 transition-opacity">Parent Portal</Link>
          <span>•</span>
          <Link to="/zsl-lab" className="hover:text-primary hover:opacity-100 transition-opacity">ZSL Lab</Link>
        </div>
